...
@section('content')
    ...
    <section id="inn-pg-section">
        <div class="container">
            ...
            <div class="row">
              @forelse ($results as $resultData)
                <div class="col-lg-4">
                    <div class="syllabust-box">
                        <div class="media">
                            <img src="{{ asset('frontend-asset/images/pdf-icon.png') }}" class="mr-3" alt="...">
                            <div class="media-body align-self-center">
                                <h5 class="mt-0 mb-0"><a href="{{ asset('storage/' . $resultData->pdf) }}" target="_blank">{{ $resultData->title }}</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-lg-4">
                    <div class="syllabust-box">
                        <div class="media">
                            <img src="{{ asset('frontend-asset/images/pdf-icon.png') }}" class="mr-3" alt="...">
                            <div class="media-body align-self-center">
                                <h5 class="mt-0 mb-0"><a href="#">No Results Available</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
