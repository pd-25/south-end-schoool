  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-lg-12 text-center">
        <h2>Middle School (Grade VI To Grade VIII)</h2>
        <p> The Middle programme of SES is structured to meet children's varied intellectual and developmental needs. The curriculum builds on concepts and skills learnt in the Primary years. It incorporates streamlined education and review of a child's performance through assessments. </p>
	   ...
	   <li><i class="fa fa-check" aria-hidden="true"></i> 2nd Language (Bengali/Hindi) </li>
	   <li><i class="fa fa-check" aria-hidden="true"></i> 3rd Language (Bengali/Hindi) </li>
	   ...
	   <li><i class="fa fa-check" aria-hidden="true"></i> Computer Studies</li>
	   <li><i class="fa fa-check" aria-hidden="true"></i> General Knowledge</li>
	   </ul>
	   </div>
		</div>	   
	   <div class="col-lg-5">
	   <div class="grade-box">
	   <h5><i class="fa fa-graduation-cap" aria-hidden="true"></i> Grade VII & VIII</h5>
	   <ul class="grade-list">
	   <li><i class="fa fa-check" aria-hidden="true"></i> English Language </li>
	   <li><i class="fa fa-check" aria-hidden="true"></i> Literature in English </li>
	   <li><i class="fa fa-check" aria-hidden="true"></i> 2nd Language (Bengali/Hindi) </li>
