  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center mb-3">
       ...
       <img src="{{ asset('frontend-asset/images/librarian-image.jpg') }}" class="img-fluid w-100 mb-3">
	   <h4>Ms. SOMA MUKHERJEE CHATTERJEE</h4>
	   <p class="c_name mb-2"><span>Designation:</span> Librarian</p>
	   <p class="mb-0"><span>Qualification:</span> M.A. (Economics), M.L.I.S. (Library Science)</p>
	   <p class="mb-0"><span>Experience:</span> 5 Years</p>
      </div>
	  </div>
	  <div class="col-lg-3 mb-4">
		<div class="teacher-box">
